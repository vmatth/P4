function [distances, distance, tau, MaxIndex] = DistanceCalc(playback, recorded, setup,index, mic)
%% Load
...
%       title(str);
%    % savestr = sprintf('WGN_TEST_%d_mic:_%d_at_40cm_speakerDIstance.png', index, mic);
%    savestr = sprintf('WGN_TEST_%d_mic_%d_at65cm.png', index, mic) 
%    saveas(gcf,savestr);
